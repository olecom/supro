...
пример_названия
    ...
    ,warn_js:
'Запуск различного JS кода на сервере разрешён для любого подключения!<br/><br/>' +
'В конфигурации этого приложения не указан модуль "userman", реализующий права доступа.'
